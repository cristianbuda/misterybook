					...
					<div class="item active">
						<img src="../../img/misteryhome.jpg" alt="" class="img-responsive">
					   	<div class="carousel-caption">
					   		...
					   		<a href="#" class="btn btn-sm btn-primary" title="Read the book">Read the book</a>
					   		<a href="#" class="btn btn-sm btn-primary" title="View & vote proposed titles">View & vote proposed titles</a>
					   		<a href="#" class="btn btn-lg btn-primary" title="Propose another title">Propose another title</a>
					   	</div> 
					</div>
				</div>
			</div>

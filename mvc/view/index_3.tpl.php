					...
					<div class="item active">
						<img src="../../img/misteryhome.jpg" alt="" class="img-responsive">
					   	<div class="carousel-caption">
					   		...
					   		<a href="#" class="btn btn-sm btn-primary" title="Read the partial book">Read the partial book</a>
					   		<a href="#" class="btn btn-lg btn-primary" title="Submit a proposal for next chapter">Submit a proposal for next chapter</a>
					   	</div> 
					</div>
				</div>
			</div>
